...
<center></br>List of target sequences from DrugBank containing </br>[{{$keyword}}]</center>
                ...
                <tr>
                    ...
                    <td>{{$d->uniprotid}}</td>
                    <td>{{$d->name}}</td>
                    <td style="word-wrap: break-word; word-break: break-all; white-space: normal;">{{$d->sequence}}</td>
                </tr>
                @endforeach
                </tbody>
                <tfoot><tr>
